...
public class ComposerData {
    ...
    public ComposerData() {
        ...
        composers.put("1", new Composer("1", "Thabeheli", "Bacha", "Baroque"));
        composers.put("2", new Composer("2", "Limela", "reli", "Baroque"));
        ...
        composers.put("8", new Composer("8", "Lineo", "Papi", "Classical"));
        composers.put("9", new Composer("9", "Bokang", "Brah", "Classical"));
        composers.put("10", new Composer("10", "Nakalo", "vali", "Classical"));
        ...
        composers.put("13", new Composer("13", "Lebona", "Haydn", "Classical"));
        composers.put("14", new Composer("14", "Tumelo", "Mahler", "Classical"));
        composers.put("15", new Composer("15", "Khanya", "Mozart", "Classical"));
        composers.put("16", new Composer("16", "Lipelo", "Pachelbel", "Classical"));
        ...
        composers.put("22", new Composer("22", "Majali", "Cui", "Romantic"));
        ...
        composers.put("27", new Composer("27", "Elelloa", "Grieg", "Romantic"));
        composers.put("28", new Composer("28", "Ntili", "Rimsky-Korsakov", "Romantic"));
        composers.put("29", new Composer("29", "Mathea Lira", "Liszt", "Romantic"));
        ...
        composers.put("34", new Composer("34", "Fakoa", "Schubert", "Romantic"));
        composers.put("35", new Composer("35", "Robert", "Schumann", "Romantic"));
        composers.put("36", new Composer("36", "Jeanclaode", "Sibelius", "Romantic"));
        ...
        composers.put("42", new Composer("42", "khabiso", "Bernstein", "Post-Romantic"));
        composers.put("43", new Composer("43", "Benjamin", "Britten", "Post-Romantic"));
        composers.put("44", new Composer("44", "Joale", "Cage", "Post-Romantic"));
        composers.put("45", new Composer("45", "Mohauhele", "Copland", "Post-Romantic"));
